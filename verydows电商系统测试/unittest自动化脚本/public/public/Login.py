...
# 接口测试 header = { 'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,
# ' 'image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9 ', 'Cookie': 'VDSSKEY=u0c6kc08h4cbbfutmemba39aia;
# UVID=2c20ec487f0ee8085e6dbd55d915c62d; LOGINED_USER=liwenda', 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64;
# x64) AppleWebKit/537.36 (KHTML, like Gecko) ' 'Chrome/104.0.5112.102 Safari/537.36' } url = self.driver.current_url
# response = requests.get(url=url, headers=header) print(response.status_code) print(response.headers)
